...
export default function About() {
  return (
    <>
      <NextSeo
        title="About Animesh Manna | React and Backend Developer"
        description="Learn more about Animesh Manna, a dedicated React and Backend Developer with 6 years of experience. Discover the journey, skills, and passion that drive me to create innovative and user-friendly web solutions."
        canonical={`${siteMetadata.siteUrl}/about`}
        openGraph={{
          url: `${siteMetadata.siteUrl}/about`,
          title: "Learn About Animesh Manna - React and Backend Developer",
          description:
            "Dive into the story of Animesh Manna, a React and Backend Developer. Uncover the experiences, skills, and passion that fuel a commitment to delivering exceptional web solutions.",
          images: [
            {
        ...
        additionalMetaTags={[
          {
            property: "keywords",
            content:
              "About Me, React Developer, Backend Developer, Web Developer, JavaScript, HTML, CSS, Professional Journey, Skills, Passion for Web Development",
          },
        ]}
      />
